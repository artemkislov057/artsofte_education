...
public class GetLessonExample : IMultipleExamplesProvider<GetLessonDto>
{
    ...
    {
        yield return SwaggerExample.Create("Video", new GetLessonDto(1, "Video Lesson",
            LessonTypeDto.Video,
        ...
        yield return SwaggerExample.Create("Presentation", new GetLessonDto(2, "Presentation Lesson",
        ...
        yield return SwaggerExample.Create("Literature", new GetLessonDto(3, "Literature Lesson",
